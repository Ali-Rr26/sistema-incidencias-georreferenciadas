  ...
  async onInit() {
    ...
    const modal = () =>
      bootstrap.Modal.getOrCreateInstance(
        document.getElementById('modal-loc-form'),
      );
    ...
    function delegarClicks(contenedor) {
      contenedor.addEventListener('click', async (e) => {
        ...
        if (editar) {
          document.getElementById('modal-loc-titulo').textContent =
            'Editar Localización';
          ...
          document.getElementById('loc-padre').value =
