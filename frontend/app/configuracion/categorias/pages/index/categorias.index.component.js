  ...
  async onInit() {
    ...
    const modal = () =>
      bootstrap.Modal.getOrCreateInstance(
        document.getElementById('modal-cat-form'),
      );
    ...
    async function cargarOrgs() {
      ...
      [
        document.getElementById('cat-org'),
        document.getElementById('filtro-org'),
      ].forEach((sel) => {
