...
async function refreshDashboard() {
  ...
  try {
    ...
    // WU7: ARIA label for the new "Pendientes de aprobación" card.
    // The card's label is set in HTML; this just gives screen readers
    // a stable name + the current value.
    updateCardAccessibility(
      cards[5],
      __('Pendientes de aprobación'),
      pendingApproval,
      null,
    );
